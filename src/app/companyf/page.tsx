      ...
      <main className="flex-1 py-12 px-4 md:px-6">
        <section className="max-w-5xl mx-auto">
          ...
          <div className="mb-4 flex gap-4">
            ...
            <select value={priceFilter || ""} onChange={(e) => setPriceFilter(parseInt(e.target.value) || null)} className="p-2 border border-gray-300 rounded">
                ...
                <CardContent>
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-sm text-muted-foreground">
                      Funding Goal: Rs {e.moneyrequired}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      Progress: 75%
                    </div>
      ...
      <footer className="bg-muted text-muted-foreground py-6 px-4 md:px-6">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="text-sm">
            &copy; 2024 CSR Connect. All rights reserved.
          </div>
          <div className="flex items-center gap-4">
