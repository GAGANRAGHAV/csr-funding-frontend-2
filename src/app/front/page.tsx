  ...
  return (
    (<div
      ...
      <div className="mx-auto max-w-md space-y-6 text-center">
        <h1
          className="text-3xl font-bold tracking-tighter text-foreground sm:text-4xl">Welcome to our Platform</h1>
        <p className="text-muted-foreground">Connect NGOs and companies to make a real impact.</p>
